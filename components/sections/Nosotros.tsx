...
/**
 * Panel de media con tres niveles de respaldo, en orden:
 *  1. /public/nosotros-video.mp4 → video corto en loop (silencioso), ej. toma aérea con dron
 *  2. /public/nosotros.jpg       → si no hay video, cae a foto estática
 *  3. Panel decorativo           → si tampoco hay foto, nunca se rompe visualmente
 * (ver public/README.md para specs de cada asset)
 */
function FotoPanel() {
        ...
        >
          ...
          <div className="flex flex-col gap-4">
            {empresa.historia.map((parrafo, i) => (
              <p key={i} className="font-body text-[1rem] text-ink-muted sm:text-lg">
                {parrafo}
              </p>
            ))}
          </div>
