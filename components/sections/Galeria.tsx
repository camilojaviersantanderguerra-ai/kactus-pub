      ...
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-14 px-6">
        ...
        {hasImages ? (
          <motion.div
            ...
            className="grid w-full grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-3"
          >
            {galeriaImages.map((img, i) => (
              <motion.button
                ...
                className="group relative aspect-square block w-full overflow-hidden rounded-2xl border border-hairline bg-base focus:outline-none"
              >
                <Image
                  src={img.src}
                  alt={img.alt}
