...
export const galeriaImages: GaleriaImage[] = [
  ...
  { src: "/galeria/pista-baile-luces.jpg", alt: "Pista de baile llena bajo las luces de colores" },
  { src: "/galeria/torta-cactus-velas.jpg", alt: "Torta temática de cactus con velas encendidas" },
  { src: "/galeria/terraza-nocturna.jpg", alt: "Terraza de Kactus Pub de noche con mesas ocupadas" },
];
